For the server / raspberry pi setup, you can use the following commands to install and configure the necessary software:
Update the package list and install the required packages:
- FastApi (for creating the server)
- Uvicorn (for running the server)
- OpenCV (for taking pictures and processing images)
[Packages For Server](First%Implementations/docs/ServerPackages.png)
...
[Packages For Client](First%Implementations/docs/ClientPackages.png)